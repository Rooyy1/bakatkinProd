...
VIDEO_FILE_ID = "BAACAgIAAxkBAAMLadDZoDZ7qoAMhxpbIK-sM9G1T3MAAhWQAAI3TMBJ9J8-v_ksxaM7BA"

# 🎥 FILE_ID эфира (после кнопки)
EFIR_FILE_ID = "BAACAgIAAxkBAAMOadDZu2XlsISC0Du9G3GBloCMxlAAAvifAAIVjFhJ8n1MSKXLylE7BA"

# 📸 FILE_ID фото для догрева
REMINDER_PHOTO_ID = "AgACAgIAAxkBAAMRadDZzbpgnUpU5njZ7CzSCJ_xNv4AAjAZaxuuOMFJe4wis7e89QUBAAMCAAN5AAM7BA"

# 📸 FILE_ID фото для приветствия
WELCOME_PHOTO_ID = "AgACAgEAAxkBAAMIadDZf5YSG8mQs1of_5ErykRWGUkAAqMLaxtGGFFGqKNQPSmC2WMBAAMCAAN5AAM7BA"
